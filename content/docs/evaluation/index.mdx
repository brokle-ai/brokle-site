...
```python
# Numeric score (0-1)
client.scores.submit(trace_id="...", name="accuracy", value=0.92)

# Categorical score
client.scores.submit(trace_id="...", name="tone", value="professional")

# Boolean score
client.scores.submit(trace_id="...", name="contains_pii", value=False)
```
...
```python
# Start with these
client.scores.submit(trace_id=trace_id, name="response_length", value=len(response))
client.scores.submit(trace_id=trace_id, name="user_feedback", value=user_rating)
```
