...
| `sort_by` | string | No | Sort field (default: `startTime`) |
...
<Tabs>
  <Tab value="curl" label="cURL">
    ```bash
    curl -X GET "https://api.brokle.com/api/v1/traces?projectId=proj_123&limit=50" \
  ...
  <Tab value="python" label="Python">
    ...
    response = requests.get(
        "https://api.brokle.com/api/v1/traces",
        headers={
