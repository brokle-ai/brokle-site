...
description: Brokle is an open-source AI observability platform for tracing, evaluation, cost analytics, and prompt management
---
...
<Cards>
  <Card
    title="Tracing"
    description="Capture every LLM call, retrieval, and tool use with distributed tracing"
    href="/docs/tracing"
  />
  <Card
    title="Evaluation"
...
Brokle is fully open source under the MIT license. We believe observability tools should be transparent, customizable, and free from vendor lock-in.
