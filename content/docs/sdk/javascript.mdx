...
| `transport` | string | `"http"` | Transport protocol: `"http"` or `"grpc"` ([guide](/docs/sdk/grpc-transport)) |
| `grpcEndpoint` | string | `undefined` | Explicit gRPC endpoint ([guide](/docs/sdk/grpc-transport)) |
